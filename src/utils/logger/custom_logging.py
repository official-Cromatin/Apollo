...
class Custom_Logger:
    ...
    def initialize(cls):
        ...
        events_logger = logging.getLogger("evnt")
        events_logger.addHandler(cls.console_handler)
        events_logger.setLevel(logging.DEBUG)

        views_logger = logging.getLogger("view")
        views_logger.addHandler(cls.console_handler)
