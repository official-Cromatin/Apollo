...
class Apollo_Bot(commands.Bot):
    ...
    async def setup_hook(self):
        ...
        for cog_name in ["reload", "economy.currency", "economy.leaderboard", "economy.dailymoney", "economy.give", "gamble.group", "economy.pick", "economy.plant", "leveling.rank", "leveling.ranks", "setup.group"]:
