...
class Apollo_Bot(commands.Bot):
    ...
    async def setup_hook(self):
        ...
        for cog_name in ["reload", "economy.currency", "economy.leaderboard", "economy.setup-dailymoney", "economy.dailymoney", "economy.give", "economy.gamble.group", "economy.pick", "economy.plant", "leveling.rank", "leveling.ranks"]:
