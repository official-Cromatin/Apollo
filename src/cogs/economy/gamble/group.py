...
from cogs.economy.gamble.impls.betroll_impl import Betroll_Impl
from cogs.economy.gamble.impls.slot_impl import Slot_Impl
...
class Gamble_CommandGroup(Base_GroupCog, group_name='gamble'):
    ...
    async def cog_load(self):
        ...
        await self.__bot.load_extension("cogs.economy.gamble.impls.betroll_impl")
        await self.__bot.load_extension("cogs.economy.gamble.impls.slot_impl")
    ...
    async def cog_unload(self):
        ...
        await self.__bot.unload_extension("cogs.economy.gamble.impls.betroll_impl")
        await self.__bot.unload_extension("cogs.economy.gamble.impls.slot_impl")
